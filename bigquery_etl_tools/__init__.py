...
from .storage_utils import dataframe_to_storage as dataframe_to_storage_inner 
from .bigquery_utils import storage_to_bigquery as storage_to_bigquery_inner
from .etl_utils import dataframe_to_bigquery as dataframe_to_bigquery_inner
from .etl_utils import autodetect_dataframe_schema as autodetect_dataframe_schema_inner
...
class BigqueryEtlClient:
    ...
    def dataframe_to_storage(
        ...
        """
        return dataframe_to_storage_inner(
            self.storage_client,
            dataframe,
            self.bucket_name,
            blob_name,
    ...
    def storage_to_bigquery(
        ...
        @return The load job
        """
        return storage_to_bigquery_inner(
            blob,
    ...
    def dataframe_to_bigquery(
        ...
        """
        return dataframe_to_bigquery_inner(
            dataframe,
            self.bucket_name,
            blob_name,
            table_id,
    ...
    def autodetect_dataframe_schema(
        ...
        """
        return autodetect_dataframe_schema_inner(
            dataframe,
            self.bucket_name,
            blob_name,
            table_id,
